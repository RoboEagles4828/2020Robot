...
class Climber:
    ...
    def __init__(self, climber_left: ctre.WPI_TalonSRX,
                 ...
                 winch_left_front: ctre.WPI_TalonSRX,
                 winch_left_back: ctre.WPI_TalonSRX,
                 winch_right_front: ctre.WPI_TalonSRX,
        ...
        self.winch_left_speed = 0
        self.winch_right_speed = 0
    ...
    def set_winch_left_speed(self, speed):
        self.winch_left_speed = speed

    def set_winch_right_speed(self, speed):
        self.winch_right_speed = speed

    def execute(self):
        self.climber_left.set(self.climber_left_speed)
        self.climber_right.set(self.climber_right_speed)
        self.winch_left_front.set(self.winch_left_speed)
        self.winch_left_back.set(-self.winch_left_speed)
        self.winch_right_front.set(-self.winch_right_speed)
        self.winch_right_back.set(self.winch_right_speed)
